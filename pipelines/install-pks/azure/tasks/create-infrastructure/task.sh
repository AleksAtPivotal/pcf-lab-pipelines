...
if [[ ! terraform.tf == "c0-azure-base" ]]; then
  cp -rn pcf-pipelines/install-pcf/azure/terraform/c0-azure-base/* pcf-pipelines/install-pcf/azure/terraform/terraform.tf/
fi
...
terraform init "pcf-lab-pipelines/install-pks/azure/terraform/terraform.tf"
...
terraform plan \
  ...
  "pcf-lab-pipelines/install-pks/azure/terraform/terraform.tf"
